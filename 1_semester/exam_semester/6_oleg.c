...
int main(void) {
  ...
  */
  #define cycle(i) for(ind[i] = 0; ind[i] < n; ind[i]++)

  int keys[] = {90, 31, 34, 5, 11, 64, 17, 30, 52, 63};
  int n = 10;
  int ind[10] = {0};
                  ...
                  cycle(8) {
                    cycle(9) {
                      ...
                      if (diff == 0) {
                        ...
                        for (int i = 0; i < n; i++) {
                          tree = insert(tree, keys[ind[i]]);
                        }

                        if (count_rotetes_left_20 >= 3) {
                          for (int i = 0; i < n; i++) {
                            printf("%d ", ind[i]);
                          }
                          printf("\n");
                        ...
                        for (int i = 0; i < n; i++) {
                          tree = remove_node(tree, keys[i]);
                        }
                        tree = NULL;
                      }

                      count_rotetes_left_20 = 0;
                    }
                  }
                }
              }
